...
public class WebActionSteps {
    ...
    @Если("кликнуть на элемент обзора файлов {string}")
    public void clickOnBrowseElement(String elementName) {
        SelenideElement element = pageManager
                .getCurrentPage()
                .getElement(elementName);
        element
                .sendKeys("C:\\Users\\shchur\\IdeaProjects\\learning\\mytestsfiles\\Screenshot.png");
        LOGGER.info("клик на элемент '{}'", elementName);
    }
